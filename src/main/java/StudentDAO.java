...
public class StudentDAO {
    ...
    public static ArrayList<Student> searchByName(String name) {
        ...
        try {
            ...
            System.out.println("Paieska pagal varda ivykdyta sekmingai");
        } catch (SQLException e) {
            System.out.println("Paieska vardo nesekminga");
            e.printStackTrace();
        }
        return studentai;
    }
    ...
    public static void deleteByName(String name) {
        ...
        try {
            ...
            System.out.println("Duomenys pagal varda istrinti sekmingai");
        } catch (SQLException e) {
            System.out.println("Duomenu pagal varda istrinti nepavyko");
            e.printStackTrace();
        }
    }
